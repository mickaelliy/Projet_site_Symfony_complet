 ...
 * @ORM\Entity(repositoryClass="Mickweb\EcommerceBundle\Repository\CommandesRepository")
 */
class Commandes
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Mickweb\UserBundle\Entity\User", inversedBy="commandes") 
