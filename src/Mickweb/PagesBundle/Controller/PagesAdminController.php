...
use Mickweb\PagesBundle\Entity\Pages;
...
class PagesAdminController extends Controller
{
    ...
    {
        $page = new Pages();
        $form = $this->createForm('Mickweb\PagesBundle\Form\PagesType', $page);
    ...
    {
        $deleteForm = $this->createDeleteForm($page);
        $editForm = $this->createForm('Mickweb\PagesBundle\Form\PagesType', $page);
